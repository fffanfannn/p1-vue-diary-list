<template>
  ...
  <button @click="sortByInputDisplay">Diary input</button>
  <button @click="sortBySearchDisplay">Search</button>
  <button @click="sortByDateDisplay">Sort by date</button>

  <div>
    <div v-if="isSortBySearchDisplay">
